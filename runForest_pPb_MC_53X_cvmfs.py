...
import subprocess
subprocess.Popen(["ln", "-sf", "/cvmfs/cms-opendata-conddb.cern.ch/STARTHI53_V27.db", "STARTHI53_V27.db"]); subprocess.Popen(["ln", "-sf", "/cvmfs/cms-opendata-conddb.cern.ch/STARTHI53_V27", "STARTHI53_V27"])
...
process.source = cms.Source("PoolSource",
                            ...
                            #    "file:/data/richard/MC_TESTS/pPb_RECO.root"
                                  "root://eospublic.cern.ch//eos/opendata/cms/himc/HiWinter13/Pyquen_Unquenched_AllQCDPhoton120_PhotonFilter35GeV_eta3_TuneZ2_pPb_5020GeV/GEN-SIM-RECO/pa_mixing_STARTHI53_V27-v1/00000/2AB91336-0042-E411-9D9B-24B6FDFF2B44.root"
                            ))
...
process.GlobalTag.connect = cms.string('sqlite_file:/cvmfs/cms-opendata-conddb.cern.ch/STARTHI53_V27.db')
process.GlobalTag = GlobalTag(process.GlobalTag, 'STARTHI53_V27::All', '')

from HeavyIonsAnalysis.Configuration.CommonFunctions_OD_53X_cff import overrideCentrality
from HeavyIonsAnalysis.Configuration.CommonFunctions_OD_53X_cff import overrideJEC_pPb5020
from HeavyIonsAnalysis.Configuration.CommonFunctions_OD_53X_cff import overrideJEC_Pbp5020
...
process.TFileService = cms.Service("TFileService",
 fileName=cms.string( "runForest_pPb_MC_53X_cvmfs.root" ))
