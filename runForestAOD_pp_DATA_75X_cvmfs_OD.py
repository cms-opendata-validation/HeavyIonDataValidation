...
import subprocess
subprocess.Popen(["ln", "-sf", "/cvmfs/cms-opendata-conddb.cern.ch/75X_dataRun2_v13.db", "75X_dataRun2_v13.db"]); subprocess.Popen(["ln", "-sf", "/cvmfs/cms-opendata-conddb.cern.ch/75X_dataRun2_v13", "75X_dataRun2_v13"])
...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring(
                                ...
                                "root://eospublic.cern.ch//eos/opendata/cms/Run2015E/HighPtJet80/AOD/PromptReco-v1/000/262/173/00000/3E8293B5-9894-E511-90E8-02163E011FA1.root"                      
                            )
)
...
from HeavyIonsAnalysis.Configuration.CommonFunctions_OD_75X_cff import overrideJEC_pp5020
