...
import subprocess
subprocess.Popen(["ln", "-sf", "/cvmfs/cms-opendata-conddb.cern.ch/STARTHI53_V28.db", "STARTHI53_V28.db"]); subprocess.Popen(["ln", "-sf", "/cvmfs/cms-opendata-conddb.cern.ch/STARTHI53_V28", "STARTHI53_V28"])
...
process.source = cms.Source("PoolSource",
    ...
    "root://eospublic.cern.ch//eos/opendata/cms/himc/HiWinter13/Pythia_AllQCDPhotons_PtHat120_TuneZ2_cmssw53p14_2760GeV/GEN-SIM-RECO/STARTHI53_V28-v1/00000/0EAF7847-899B-E311-AC57-F04DA275BFFB.root"
    ))
...
process.GlobalTag.connect = cms.string('sqlite_file:/cvmfs/cms-opendata-conddb.cern.ch/STARTHI53_V28.db')
...
process.TFileService = cms.Service("TFileService",
 fileName=cms.string( "runForest_pp_MC_53X_cvmfs.root" ))
