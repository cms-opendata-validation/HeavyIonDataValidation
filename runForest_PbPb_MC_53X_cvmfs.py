...
import subprocess
subprocess.Popen(["ln", "-sf", "/cvmfs/cms-opendata-conddb.cern.ch/STARTHI53_LV1.db", "STARTHI53_LV1.db"]); subprocess.Popen(["ln", "-sf", "/cvmfs/cms-opendata-conddb.cern.ch/STARTHI53_LV1", "STARTHI53_LV1"])
...
process.source = cms.Source("PoolSource",
      ...
      "root://eospublic.cern.ch//eos/opendata/cms/himc/HiFall13DR53X/Hydjet1p8_TuneDrum_Quenched_MinBias_2760GeV/GEN-SIM-RECO/NoPileUp_STARTHI53_LV1-v1/00000/000D7E3C-BE6B-E411-A7D4-00266CF9B414.root"
      ))
...
process.GlobalTag.connect = cms.string('sqlite_file:/cvmfs/cms-opendata-conddb.cern.ch/STARTHI53_LV1.db')
process.GlobalTag = GlobalTag(process.GlobalTag, 'STARTHI53_LV1::All', '')

from HeavyIonsAnalysis.Configuration.CommonFunctions_OD_53X_cff import *
...
process.TFileService = cms.Service("TFileService",
 fileName=cms.string( "runForest_PbPb_MC_53X_cvmfs.root" ))
